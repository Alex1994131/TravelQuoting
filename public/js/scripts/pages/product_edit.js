...
Dropzone.options.dpzRemoveAllThumb = {
  ...
  init: function () {
	for(var i=0; i<image_gallery.length; i++) {
		var mockFile = {
			name: image_gallery[i].path.split('/')[2],
			size: 100,
			type: 'image/*',
			serverID: i,
			accepted: true
		...
		this.emit("thumbnail", mockFile, base_url + '/'+image_gallery[i].path);
...
function addpricetype(index) {
  ...
  var html = '<div class="row" id="pricinglist_' + index + '_'+ idx +'">' +
    ...
    '<div class="col-md-3">' +
    '<fieldset class="form-group position-relative has-icon-left">' +
    '<input type="number" id="price_' + index + '_'+ idx +'" name="price['+ (index-1) +'][]" class="touchspin-icon" value="" data-bts-step="0.5" data-bts-decimals="2" data-bts-prefix="$" placeholder="Price" min="0">' +
    '</fieldset>' +
    '</div>' +
...
function copypriceset(copy_index) {
  ...
  for(var i=0; i<pricing_list.length; i++) {
    ...
    sub_html += '<div class="row" id="pricinglist_'+ index +'_'+ (i+1) +'">'+
      ...
      '<div class="col-md-3">'+
      '<fieldset class="form-group position-relative has-icon-left">'+
      '<input type="number" id="price_'+ index +'_'+ (i+1) +'" name="price['+ (index-1) +'][]" class="touchspin-icon" value="'+ price_val +'" data-bts-step="0.5" data-bts-decimals="2" data-bts-prefix="$" placeholder="Price" min="0">'+
      '</fieldset>'+
      '</div>'+
      '<div class="col-md-3 form-group">'+
...
jQuery(document).ready(function () {
		...
		'<div class="col-md-12 d-flex align-items-center justify-content-between">'+
			'<h6 class="d-flex align-items-center">'+
				...
				'<div class="avatar mr-1 avatar-lg">'+
					'<img src="'+ base_url+'/images/flags/'+ lang +'.png" alt="avtar img holder" class="flag">'+
		  		'</div>'+
			'</h6>'+
	...
	$("#description_form").on('submit', function() {
  ...
  $("#priceset_add").on('click', function() {
    ...
    var html = '<div class="row mb-1" id="pricingset_'+ index +'" style="border: 1px solid #ccc; padding-top: 20px;">'+
      ...
      '<div class="col-md-3">'+
      '<fieldset class="form-group position-relative has-icon-left">'+
      '<input type="number" id="price_'+ index +'_1" name="price['+ (index-1) +'][]" class="touchspin-icon" value="" data-bts-step="0.5" data-bts-decimals="2" data-bts-prefix="$" placeholder="Price" min="0">'+
      '</fieldset>'+
      '</div>'+
      '<div class="col-md-3 form-group">'+
  ...
  $("#pricing_form").on('submit', function() {
