...
<section>
  ...
  <!-- task_type -->
  <div class="modal fade text-left" id="task_type_detail_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
      aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel18">Task Type Detail</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <i class="bx bx-x"></i>
          </button>
        </div>
        <div class="modal-body">
          <div class="row mb-1">
            ...
            <div class="col-md-6 form-group" >
              <input type="text" id="task_type_name" name="task_type_name" class="form-control" placeholder="Task Type Name" required>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" onClick="save_task_type()" class="btn btn-primary ml-1">
            <i class="bx bx-check d-block d-sm-none"></i>
            <span class="d-none d-sm-block">Save</span>
          </button>
          <button type="button" class="btn btn-light-secondary" data-dismiss="modal">
  ...
  <!-- customer_type -->
  <div class="modal fade text-left" id="customer_detail_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
      aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel18">Customer Detail</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <i class="bx bx-x"></i>
          </button>
        </div>
        ...
        <div class="modal-footer">
          <button type="button" onClick="save_customer()" class="btn btn-primary ml-1">
            <i class="bx bx-check d-block d-sm-none"></i>
            <span class="d-none d-sm-block">Save</span>
          </button>
          <button type="button" class="btn btn-light-secondary" data-dismiss="modal">
  ...
  <!-- city -->
  <div class="modal fade text-left" id="city_detail_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
      aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel18">city Detail</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <i class="bx bx-x"></i>
          </button>
        </div>
        <div class="modal-body">
          ...
          <div class="row mb-1">
            ...
            <div class="col-md-6 form-group" >
              <input type="text" id="city_title" name="city_title" class="form-control" placeholder="city Name" required>
            </div>
          </div>
          ...
          <div class="row mb-1">
            ...
            <div class="col-md-6 form-group" >
              <select class="select2 form-control" id="region_name" name="region_name" required data-validation-required-message="This title field is required">
              </select>
            </div>
          </div>
          <div class="row mb-1">
            ...
            <div class="col-md-6 form-group" >
              <select class="select2 form-control" id="country_name" name="country_name" required data-validation-required-message="This title field is required">
              </select>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" onClick="save_city()" class="btn btn-primary ml-1">
            <i class="bx bx-check d-block d-sm-none"></i>
            <span class="d-none d-sm-block">Save</span>
          </button>
          <button type="button" class="btn btn-light-secondary" data-dismiss="modal">
  ...
  <!-- country -->
  <div class="modal fade text-left" id="country_detail_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
      aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel18">country Detail</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <i class="bx bx-x"></i>
          </button>
        </div>
        <div class="modal-body">
          ...
          <div class="row mb-1">
            ...
            <div class="col-md-6 form-group" >
              <input type="text" id="country_title" name="country_title" class="form-control" placeholder="country Name" required>
            </div>
          </div>
          ...
          <div class="row mb-1">
            ...
            <div class="col-md-6 form-group" >
              <input type="text" id="code_title" name="code_title" class="form-control" placeholder="code" required>
            </div>
          </div>
          ...
          <div class="row mb-1">
            ...
            <div class="col-md-6 form-group" >
              <input type="text" id="phonecode_title" name="phonecode_title" class="form-control" placeholder="phone code" required>
            </div>
          </div>
          ...
          <div class="row mb-1">
            ...
            <div class="col-md-6 form-group" >
              <select class="select2 form-control" id="country_region_name" name="country_region_name" required data-validation-required-message="This title field is required">
              </select>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" onClick="save_country()" class="btn btn-primary ml-1">
            <i class="bx bx-check d-block d-sm-none"></i>
            <span class="d-none d-sm-block">Save</span>
          </button>
          <button type="button" class="btn btn-light-secondary" data-dismiss="modal">
...
<section>
  ...
  <div class="row">
    ...
    <div class="col-6">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Task Type </h4>
          <a class="heading-elements-toggle">
            <i class='bx bx-dots-vertical font-medium-3'></i>
          </a>
          <div class="heading-elements">
        ...
        <div class="card-content collapse">
          <div class="card-body">
            <div class="col-md-12 d-flex justify-content-end mb-1">
                <button class="btn btn-primary" onclick="detail_task_type(0)">ADD</button>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="invoice-list-wrapper">
                  ...
                  <div class="table-responsive">
                    <table id="task_type_table" class="table invoice-data-table dt-responsive nowrap" style = "width:100%">
                      <thead>
                        <tr>
                          <th></th>
                          <th class="text-center">NO</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center">{{$task_type->title}}</td>
                          ...
                          <td class="text-center">
                            <div class="dropdown">
                              <span class="bx bx-slider-alt font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                              <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="javascript:void(0)" onClick="detail_task_type({{$task_type->id}})"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                <a class="dropdown-item" href="javascript:void(0)" onClick="task_type_del({{$task_type->id}})"><i class="bx bx-trash mr-1"></i> delete</a>
                              </div>
                            </div>
                          </td>
    ...
    <div class="col-6">
      <div class="card">
        ...
        <div class="card-content collapse">
          <div class="card-body">
            <div class="col-md-12 d-flex justify-content-end mb-1">
                <button class="btn btn-primary" onclick="detail_customer(0)">ADD</button>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="invoice-list-wrapper">
                  ...
                  <div class="table-responsive">
                    <table id="customer_table" class="table invoice-data-table dt-responsive nowrap" style = "width:100%">
                      <thead>
                        <tr>
                          <th></th>
                          <th class="text-center">NO</th>
                          ...
                          <td class="text-center">
                            <div class="dropdown">
                              <span class="bx bx-slider-alt font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                              <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="javascript:void(0)" onClick="detail_customer({{$customer->id}})"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                <a class="dropdown-item" href="javascript:void(0)" onClick="customer_del({{$customer->id}})"><i class="bx bx-trash mr-1"></i> delete</a>
                              </div>
                            </div>
                          </td>
    ...
    <div class="col-6">
      <div class="card">
        ...
        <div class="card-content collapse">
          <div class="card-body">
            <div class="col-md-12 d-flex justify-content-end mb-1">
                <button class="btn btn-primary" onclick="detail_city(0)">ADD</button>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="invoice-list-wrapper">
                  ...
                  <div class="table-responsive">
                    <table id="city_table" class="table invoice-data-table dt-responsive nowrap" style = "width:100%">
                      <thead>
                        <tr>
                          <th></th>
                          <th class="text-center">NO</th>
                      ...
                      <tbody>
                       ...
                       @foreach($citys as $key => $city)
                        ...
                        <tr>
                          ...
                          <td class="text-center">{{$city->get_region_title()}}</td>
                          <td class="text-center">{{$city->get_country_title()}}</td>
                          ...
                          <td class="text-center">
                            <div class="dropdown">
                              <span class="bx bx-slider-alt font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                              <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="javascript:void(0)" onClick="detail_city({{$city->id}})"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                <a class="dropdown-item" href="javascript:void(0)" onClick="city_del({{$city->id}})"><i class="bx bx-trash mr-1"></i> delete</a>
                              </div>
                            </div>
                          </td>
    ...
    <div class="col-6">
      <div class="card">
        ...
        <div class="card-content collapse">
          <div class="card-body">
            <div class="col-md-12 d-flex justify-content-end mb-1">
                <button class="btn btn-primary" onclick="detail_country(0)">ADD</button>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="invoice-list-wrapper">
                  ...
                  <div class="table-responsive">
                    <table id="country_table" class="table invoice-data-table dt-responsive nowrap" style = "width:100%">
                      <thead>
                        <tr>
                          <th></th>
                          <th class="text-center">NO</th>
                          ...
                          <th class="text-center">Phonecode</th>
                      ...
                      <tbody>
                       ...
                       @foreach($countrys as $key => $country)
                        ...
                        <tr>
                          ...
                          <td class="text-center">{{$country->get_region_title()}}</td>
                          <td class="text-center">
                            <div class="dropdown">
                              <span class="bx bx-slider-alt font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                              <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="javascript:void(0)" onClick="detail_country({{$country->id}})"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                <a class="dropdown-item" href="javascript:void(0)" onClick="country_del({{$country->id}})"><i class="bx bx-trash mr-1"></i> delete</a>
                              </div>
                            </div>
                          </td>
