  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel17">Task Details For Product</h4>
  ...
  <div class="row breadcrumbs-top">
    ...
    <div class = "col-6">
      <ul class="nav nav-tabs float-right" role="tablist">
          <li class="nav-item">
            <div class="dropdown">
                <span class="font-medium-1 dropdown-toggle nav-hide-arrow cursor-pointer nav-link btn-primary glow white"
      ...
      <div id="collapse6" role="tabpanel" aria-labelledby="headingCollapse6" class="collapse">
        <div class="card-content">
          <div class="card-body">
              ...
              <form class="form-horizontal" method="post" action="{{route('save_basic_info')}}" novalidate id="itinerary_basic_form">
              @csrf
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-6">
              <h6>Adult Number</h6>
              <div class="d-inline-block mb-1 mr-1">
                  <input type="number" class="touchspin" value="0" id="adults_num_modal" name="adults_num_modal">
              </div>
            </div>
            <div class="col-md-6">
              <h6>Child Number</h6>
              <div class="d-inline-block mb-1 mr-1">
                  <input type="number" class="touchspin" value="0" id="children_num_modal" name="children_num_modal">
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row" style="height: 100%; overflow-y: auto">
                      ...
                      <div class="row">
                        <div class="col-md-8 d-flex align-items-center">
                          @if($itinerary_id != null)
                            <button type="button" id="itinerary_save" class="btn btn-primary" style="margin-bottom: 15px; margin-right: 10px;">Save</button>
                            <button type="button" id="template_itinerary_save" class="btn btn-primary" style="margin-bottom: 15px;">Make As Template</button>
                          @endif
                        </div>
              ...
              <div class="col-sm-12 col-md-4">
                <div class="card" style="height: 650px;">
                  <div class="card-header" style="display: flex; align-items: center; justify-content: space-between; border: 0px !important;">
                    <h5>Product</h5>
                    <a href="javascript:void(0)" id="filter_button">
                      <i class="bx bx-filter-alt" style="margin-right: 1px;font-size: 25px; color: rgb(210, 77, 83)" title="Filter Product"></i>
                    </a>
                  </div>
                  <div class="card-content">
                    <div class="card-body">
